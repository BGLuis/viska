...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String?> crateFfiCoreCoreMyNickname({required Core that});
  ...
  Future<void> crateFfiCoreCoreSetEphemeralTtl({
    required Core that,
    required List<int> contactDeviceId,
    required PlatformInt64 ttlSecs,
  });

  Future<void> crateFfiCoreCoreSetMyNickname({
    required Core that,
    required String nickname,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_list_prim_u_8_loose(peerPayload, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 2,
        ...
        constMeta: kCrateFfiCoreCoreComputeSasCodeConstMeta,
        argValues: [that, peerPayload],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateFfiCoreCoreComputeSasCodeConstMeta =>
      const TaskConstMeta(
        debugName: "Core_compute_sas_code",
        argNames: ["that", "peerPayload"],
      );
  ...
  TaskConstMeta get kCrateFfiCoreCoreEmergencyEraseConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateFfiCoreCoreGetEphemeralTtlConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateFfiCoreCoreIsLockedConstMeta =>
  ...
  TaskConstMeta get kCrateFfiCoreCoreLockConstMeta =>
  ...
  TaskConstMeta get kCrateFfiCoreCoreMarkMessageReadConstMeta =>
      const TaskConstMeta(
  ...
  Future<String?> crateFfiCoreCoreMyNickname({required Core that}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateFfiCoreCoreMyNicknameConstMeta,
        argValues: [that],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateFfiCoreCoreMyNicknameConstMeta =>
      const TaskConstMeta(debugName: "Core_my_nickname", argNames: ["that"]);
  ...
  Future<ContactDto> crateFfiCoreCorePairFromQr({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        argValues: [that, payload, nickname],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta get kCrateFfiCoreCorePairFromQrConstMeta => const TaskConstMeta(
    ...
    argNames: ["that", "payload", "nickname"],
  );
  ...
  Future<void> crateFfiCoreCoreSetContactNickname({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateFfiCoreCoreSetContactNicknameConstMeta,
        argValues: [that, contactDeviceId, nickname],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateFfiCoreCoreSetContactNicknameConstMeta =>
      const TaskConstMeta(
        debugName: "Core_set_contact_nickname",
        argNames: ["that", "contactDeviceId", "nickname"],
      );
  ...
  TaskConstMeta get kCrateFfiCoreCoreSetEphemeralTtlConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateFfiCoreCoreSetMyNickname({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateFfiCoreCoreSetMyNicknameConstMeta,
  ...
  TaskConstMeta get kCrateFfiCoreCoreSetMyNicknameConstMeta =>
      const TaskConstMeta(
        debugName: "Core_set_my_nickname",
  ...
  TaskConstMeta get kCrateFfiCoreCoreSweepExpiredMessagesConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateFfiCoreCoreUnlockConstMeta =>
...
class CoreImpl extends RustOpaque implements Core {
  ...
  Future<String> computeSasCode({required List<int> peerPayload}) => RustLib
      .instance
      .api
  ...
  Future<void> markMessageRead({required PlatformInt64 messageId}) => RustLib
      .instance
      .api
      .crateFfiCoreCoreMarkMessageRead(that: this, messageId: messageId);
  ...
  Future<String?> myNickname() =>
      RustLib.instance.api.crateFfiCoreCoreMyNickname(that: this);
  ...
  Future<ContactDto> pairFromQr({
    required List<int> payload,
    String? nickname,
  }) => RustLib.instance.api.crateFfiCoreCorePairFromQr(
    that: this,
    payload: payload,
    nickname: nickname,
  );
  ...
  Future<void> setContactNickname({
    required List<int> contactDeviceId,
    required String nickname,
  }) => RustLib.instance.api.crateFfiCoreCoreSetContactNickname(
    that: this,
    contactDeviceId: contactDeviceId,
    nickname: nickname,
  );
  ...
  Future<void> setEphemeralTtl({
    required List<int> contactDeviceId,
    required PlatformInt64 ttlSecs,
  }) => RustLib.instance.api.crateFfiCoreCoreSetEphemeralTtl(
    that: this,
    contactDeviceId: contactDeviceId,
    ttlSecs: ttlSecs,
  );
  ...
  Future<void> setMyNickname({required String nickname}) => RustLib.instance.api
      .crateFfiCoreCoreSetMyNickname(that: this, nickname: nickname);
  ...
  Future<int> sweepExpiredMessages() =>
      RustLib.instance.api.crateFfiCoreCoreSweepExpiredMessages(that: this);
